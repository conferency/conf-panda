...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/static/demos/pdf/web/images/';
  PDFJS.workerSrc = '/static/demos/pdf/pdfjs_build/pdf.worker.js';
  PDFJS.cMapUrl = '/static/demos/pdf/web/cmaps/';
