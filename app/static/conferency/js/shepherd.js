...
var Step = (function (_Evented) {
  ...
  _createClass(Step, [{
    ...
    value: function render() {
      ...
      this.el = createFromHTML('<div style="z-index:9999" class=\'shepherd-step ' + (this.options.classes || '') + '\' data-id=\'' + this.id + '\' ' + (this.options.idAttribute ? 'id="' + this.options.idAttribute + '"' : '') + '></div>');
